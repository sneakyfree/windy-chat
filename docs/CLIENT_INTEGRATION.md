...
CHAT_HOMESERVER_URL=https://chat.windypro.com   # or http://localhost:8008 for dev
...
const client = sdk.createClient({
  baseUrl: 'https://chat.windypro.com',
...
|----------|-------|-------------|
| `CHAT_HOMESERVER_URL` | `https://chat.windypro.com` | Matrix homeserver |
...
In production, all services are behind nginx on `https://chat.windypro.com`
