...
6. Windy Chat identity provisioned on chat.windyword.ai
...
- Auto-provisioned Matrix bot on chat.windyword.ai
...
2. **Synapse homeserver** — running at `chat.windyword.ai` (K1)
...
- Bot auto-joins user's DM room on chat.windyword.ai
