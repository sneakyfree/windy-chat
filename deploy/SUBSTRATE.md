...
| `bridge-slack` / `bridge-whatsapp` | `dock.mau.dev/mautrix/{slack,whatsapp}` | none (internal :29317) | same lifecycle/conventions as bridge-telegram (profile `hub`, state under /opt/windy-chat-data/bridges/<net>, enable script + gated Synapse restart) |
